...
consumer_key = 'Gunakan_Consumer_Key_Anda'
consumer_secret = 'Gunakan_Consumer_Secret_Anda'
 
qry='adarwawan'
maxTweets = 300 # Isi sembarang nilai sesuai kebutuhan anda
tweetsPerQry = 100  # Jangan isi lebih dari 100, ndak boleh oleh Twitter
fName='Hasil_Tweets.json' # Nama File hasil Crawling
consumer_key = 0 # Rahasia, Diubah dulu
consumer_secret = 0 # Rahasia, Diubah dulu
